...
import {
  SEE_ALL, SHOP_BY_PRODUCT_CATAGORY, BEST_SELLING, OUR_PRODUCT, STOREFRONT_DOMAIN, ADMINAPI_ACCESS_TOKEN, BEAUTY_OUR_PRODUCT_COLLECTION_ID,
...
const HomeScreenBeauty = ({ navigation }: { navigation: any }) => {
  ...
  const carouselData = [
    { id: 1, image: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/bannerimages%2FJwelery%2FjewelryBanner1.png?alt=media&token=fbe61826-eb84-45bf-b26f-ee06f8d7140a" },
    { id: 2, image: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/bannerimages%2FJwelery%2FjewelryBanner2.png?alt=media&token=f3cf6d57-cee4-49ec-b387-1fd3dcdc42d4" },
    { id: 3, image: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/bannerimages%2FJwelery%2FjewelryBanner3.png?alt=media&token=2d8fc80f-9fc0-4ffe-87e5-1d10df2e8c7a" },
    { id: 4, image: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/bannerimages%2FJwelery%2FjewelryBanner4.png?alt=media&token=4716ef4f-ce45-4f99-b3ae-dbb580a5a2bf" },
    { id: 5, image: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/bannerimages%2FJwelery%2FjewelryBanner5.png?alt=media&token=5fdf6e00-084b-4351-8f10-b0823d203656" }
  ];
  const GIF = { id: 1, gif: "https://firebasestorage.googleapis.com/v0/b/ecommerceapp-34078.appspot.com/o/295021d2-ecc3-4359-9f82-7b30402a1b09.gif?alt=media&token=ea0e1680-a323-4834-b79f-9becc3efd716" }

  useEffect(() => {
    logEvent('Home Screen Beauty Initialized');
  }, [])
  ...
  useEffect(() => {
    const fetchproduct = () => {
      ...
      const graphql = JSON.stringify({
        query: `query MyQuery {
      collection(id: "gid://shopify/Collection/331293982873") {
        products(first: 10) {
          nodes {
            id
            images(first: 10) {
  ...
  useEffect(() => {
    const fetchproduct = () => {
      ...
      const graphql = JSON.stringify({
        query: `query MyQuery {
        collection(id: "gid://shopify/Collection/331294572697") {
          products(first: 4) {
            nodes {
              id
              images(first: 4) {
  ...
  const handleMenuPress = (item) => {
    logEvent(`Change theme from Beauty to Themename :${item}`);
  ...
  const onPressShopAll = () => {
    logEvent('SeeAll Button Pressed from HomeScreenBeauty');
    navigation.navigate('CatalogStack')
  }

  //move to collection page
  const onPressCollection = (id: any, heading: any) => {
    logEvent(`See All our product Collection Button Pressed from HomeScreenBeauty CollectionID: ${id} CollectionName: ${heading}`);
      ...
      <View style={[styles.container, { backgroundColor: colors.whiteColor }, flex]}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ paddingHorizontal: spacings.large }}>
          ...
          <View style={[{ width: "100%", marginVertical: 10 }, alignItemsCenter, justifyContentSpaceBetween, flexDirectionRow]}>
            ...
            <Text style={{ color: redColor, fontSize: style.fontSizeNormal.fontSize, fontWeight: style.fontWeightThin1x.fontWeight }} onPress={() => onPressCollection(BEAUTY_OUR_PRODUCT_COLLECTION_ID, OUR_PRODUCT)}>{SEE_ALL}</Text>
          </View>
          <View style={[{ height: hp(30) }, alignJustifyCenter]}>
...
export default HomeScreenBeauty;
